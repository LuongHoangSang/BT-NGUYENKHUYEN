...
\begin{ex}
	...
	$$mgh_{\max}=\dfrac{1}{2}mv^2_0\Rightarrow h_{\max}=\dfrac{v^2_0}{2g}=\SI{5}{\meter}.$$
		}
\end{ex}
% ===================================================================
\begin{ex}
	...
	\loigiai{
	Áp dụng định luật bảo toàn cơ năng:
	$$mgh_{\max}=mgh+\dfrac{1}{2}mv^2\Rightarrow v=\sqrt{2g\left(h_{\max}-h\right)}\approx\SI{10.84}{\meter/\second}.$$
	}
\end{ex}
% ===================================================================
\begin{ex}
	...
	$$A=\dfrac{1}{2}mv^2_2-\dfrac{1}{2}mv^2_1=\SI{18150}{\joule}.$$}
\end{ex}
% ===================================================================
\begin{ex}
	...
	{$\SI{6605}{\newton}$}
	\loigiai{
		$F=\dfrac{\calP}{v}=\dfrac{175\cdot746}{29}\approx\SI{4502}{\newton}$.
	}
\end{ex}
% ===================================================================
\begin{ex}
	...
	\loigiai{
		...
		$$mgh_1=\dfrac{1}{2}mv^2_2+\left|F_{\text{ms}}\cdot s\cos\SI{180}{\degree}\right|\Leftrightarrow \left(\SI{3}{\kilogram}\right)\cdot\left(\SI{9.8}{\meter/\second^2}\right)\cdot\left(\SI{0.5}{\meter}\right)=\dfrac{1}{2}\cdot\left(\SI{3}{\kilogram}\right)\cdot v^2_2+\left(\SI{5}{\newton}\right)\cdot\left(\SI{1}{\meter}\right)\Rightarrow v_2\approx\SI{2.54}{\meter/\second}.$$
	}
\end{ex}
...
\begin{ex}
	...
	{Biết rằng cơ bắp con người chỉ có hiệu suất tối đa là \SI{25}{\percent} trong việc tạo ra động năng từ năng lượng hóa học (năng lượng cung cấp từ thực phẩm). Để thực hiện được cú nhảy trên thì nam sinh cần được cung cấp ít nhất \SI{83.2}{cal}}
	\loigiai{
	\begin{itemchoice}
		\itemch Đúng. $v_{\text{tb}}=\dfrac{h}{\Delta t}=\SI{1.6}{\meter/\second}$.\\
		Học sinh tăng tốc đều trong thời gian nhún chân tạo đà (chuyển động nhanh dần đều) nên $$v_{\text{tb}}=\dfrac{v+v_0}{2}\Rightarrow v=2v_{\text{tb}}=\SI{3.2}{\meter/\second}.$$
		\itemch Sai. Bỏ qua tác dụng của lực cản và lực ma sát thì cơ năng không đổi.
		\itemch Sai. Áp dụng định luật bảo toàn cơ năng tại vị trí khi vừa rời khỏi đất và vị trí đạt độ cao cực đại: $$\dfrac{1}{2}mv^2=mgH\Rightarrow H=\dfrac{v^2}{2g}\approx\SI{0.52}{\meter}.$$
		\itemch Sai. $A_{\text{tp}}=\dfrac{\dfrac{1}{2}mv^2}{H}=\SI{1392.64}{\joule}\approx\SI{333.2}{cal}.$
	\end{itemchoice}
	}
\end{ex}
\Closesolutionfile{ans}
...
\begin{ex}
	...
	\loigiai{
		$W=mg\sin\theta\cdot d=\SI{20538}{\joule}$\\
...
\begin{ex}
	...
	\loigiai{
	\begin{enumerate}[label=\alph*)]
		\item Áp dụng định luật bảo toàn cơ năng tại đỉnh dốc và chân dốc:
		\begin{eqnarray*}
			&&mgh_0=\dfrac{1}{2}mv^2_c\\
			&\Rightarrow&v_c=\sqrt{2gh_0}\approx\SI{6.26}{\meter/\second}
		\end{eqnarray*}
		\item $v'_c=\dfrac{2}{3}v_c=$.
		Áp dụng biến thiên cơ năng:
		\begin{eqnarray*}
			&&W_0=W_c+\left|A_{F_{\mathrm{ms}}}\right|\\
			&\Leftrightarrow& mgh_0=\dfrac{1}{2}mv'^2_c+\left|A_{F_{ms}}\right|\\
			&\Rightarrow &\left|A_{F_{\mathrm{ms}}}\right|=\SI{16.33}{\joule}\\
			&\Rightarrow&A_{F_{\mathrm{ms}}}=\SI{-16.33}{\joule}
		\end{eqnarray*}
	\end{enumerate}
	}
\end{ex}
...
\begin{ex}
	...
	\loigiai{Chọn gốc thế năng tại vị trí thấp thấp của con lắc.
		\begin{enumerate}[label=\alph*)]
			\item $W_0=\dfrac{1}{2}mv^2_0=\SI{16}{\joule}$.
			\item Áp dụng định luật bảo toàn cơ năng tại vị trí đầu và vị trí dây treo lệch góc \SI{30}{\degree} so với phương thẳng đứng:
			$$W_0=mg\ell\left(1-\cos\alpha\right)+\dfrac{1}{2}mv^2\Rightarrow v\approx\SI{4.84}{\meter/\second}.$$
			\item Tại vị trí $W_t=2W_{\text{đ}}$ thì $W_t=\dfrac{2}{3}W_0$.\\
			$$\Rightarrow mg\ell\left(1-\cos\alpha'\right)=\dfrac{2}{3}W_0\Rightarrow \alpha=\SI{48.2}{\degree}.$$
		\end{enumerate}
	}
\end{ex}
\Closesolutionfile{ans}
